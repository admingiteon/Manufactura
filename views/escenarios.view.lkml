...
view: escenarios {
  derived_table: {
    sql: SELECT DISTINCT(trazabilidad.Escenario_id) FROM `eon-bus-proj-cadena-demo.data_foundation.reporting_ecc_mx_tb_largo_plazo_trazabilidad_nv` as trazabilidad
