...
FROM
    `eon-bus-proj-cadena-demo.modelo_de_calculo_sm.vw_LP_PT_Inventario_LU_1` AS lp_pt_inv_lu_1
LEFT JOIN
    `eon-bus-proj-cadena-demo.modelo_de_calculo_sm.vw_LP_PT_Fabricacion_Final` AS lp_pt_fab_fin
ON
     (
                    Concat  (
                            lp_pt_inv_lu_1.material,
